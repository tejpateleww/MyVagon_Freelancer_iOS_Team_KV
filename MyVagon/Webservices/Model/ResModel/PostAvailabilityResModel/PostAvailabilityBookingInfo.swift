//
//  PostAvailabilityBookingInfo.swift
//  Model Generated using http://www.jsoncafe.com/ 
//  Created on November 30, 2021

import Foundation

struct PostAvailabilityBookingInfo : Codable {
        ...
        let shipperDetails : PostAvailabilityShipperDetail?
        let status : String?
        let totalWeight : String?
        let trucks : PostAvailabilityTruck?
        let txnId : String?
        ...
        init(from decoder: Decoder) throws {
                ...
                shipperDetails = try? values.decodeIfPresent(PostAvailabilityShipperDetail.self, forKey: .shipperDetails)
                status = try? values.decodeIfPresent(String.self, forKey: .status)
                totalWeight = try? values.decodeIfPresent(String.self, forKey: .totalWeight)
                trucks = try? values.decodeIfPresent(PostAvailabilityTruck.self, forKey: .trucks)
