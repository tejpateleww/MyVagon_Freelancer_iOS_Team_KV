//
//  PostAvailabilityTruck.swift
//  Model Generated using http://www.jsoncafe.com/ 
//  Created on November 30, 2021

import Foundation

struct PostAvailabilityTruck : Codable {
        ...
        let isCooling : Int?
        let isHydraulic : Int?
        let locations : [PostAvailabilityLocation]?
        let note : String?
        let payout : String?
        let truckId : Int?
        let truckType : Int?
        let truckTypeCategory : [PostAvailabilityTruckTypeCategory]?
        ...
        init(from decoder: Decoder) throws {
                ...
                locations = try? values.decodeIfPresent([PostAvailabilityLocation].self, forKey: .locations)
                ...
                truckTypeCategory = try? values.decodeIfPresent([PostAvailabilityTruckTypeCategory].self, forKey: .truckTypeCategory)
