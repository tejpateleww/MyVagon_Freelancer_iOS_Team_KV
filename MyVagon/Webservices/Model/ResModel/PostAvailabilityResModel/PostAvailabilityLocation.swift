//
//  PostAvailabilityLocation.swift
//  Model Generated using http://www.jsoncafe.com/ 
//  Created on November 30, 2021

import Foundation

struct PostAvailabilityLocation : Codable {
        ...
        let note : String?
        let otp : String?
        let products : [PostAvailabilityProduct]?
        let truckId : Int?
        ...
        init(from decoder: Decoder) throws {
                ...
                products = try? values.decodeIfPresent([PostAvailabilityProduct].self, forKey: .products)
