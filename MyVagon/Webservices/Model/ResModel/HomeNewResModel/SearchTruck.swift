...
struct SearchTruck : Codable {
        ...
        let payout : String?
        let truckId : Int?
        let truckType : SearchTruckType?
        let truckTypeCategory : [SearchTruckTypeCategory]?
        ...
        init(from decoder: Decoder) throws {
                ...
                locations = try? values.decodeIfPresent([SearchLocation].self, forKey: .locations)
                ...
                truckType = try? values.decodeIfPresent(SearchTruckType.self, forKey: .truckType) 
                truckTypeCategory = try? values.decodeIfPresent([SearchTruckTypeCategory].self, forKey: .truckTypeCategory)
