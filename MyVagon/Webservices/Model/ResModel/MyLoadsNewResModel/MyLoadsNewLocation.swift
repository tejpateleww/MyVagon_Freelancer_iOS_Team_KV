//
//  MyLoadsNewLocation.swift
//  Model Generated using http://www.jsoncafe.com/ 
//  Created on December 1, 2021

import Foundation

struct MyLoadsNewLocation : Codable {
        ...
        let note : String?
        let otp : String?
        let products : [MyLoadsNewProduct]?
        let truckId : Int?
        ...
        init(from decoder: Decoder) throws {
                ...
                products = try? values.decodeIfPresent([MyLoadsNewProduct].self, forKey: .products)
