...
public class StepIndicatorView: UIView {
    ...
    // Variables
    static let defaultColor = UIColor(red: 122.0/255.0, green: 122.0/255.0, blue: 122.0/255.0, alpha: 1.0)
    static let defaultTintColor = UIColor(red: 155.0/255.0, green: 81.0/255.0, blue: 224.0/255.0, alpha: 1.0)
    ...
    @IBInspectable public var numberOfSteps: Int = 2 {
        didSet {
            self.createSteps()
        }
    }
