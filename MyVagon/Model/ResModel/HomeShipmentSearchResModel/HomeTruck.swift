...
struct HomeTruck : Codable {
        ...
        let payout : String?
        let truckId : Int?
        let truckType : HomeTruckType?
        let truckTypeCategory : [HomeTruckTypeCategory]?
        ...
        init(from decoder: Decoder) throws {
                ...
                truckType = try values?.decodeIfPresent(HomeTruckType.self, forKey: .truckType)
                truckTypeCategory = try values?.decodeIfPresent([HomeTruckTypeCategory].self, forKey: .truckTypeCategory)
