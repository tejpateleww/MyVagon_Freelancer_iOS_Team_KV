...
struct BookingData: Codable {
    ...
    var id: Int?
        ...
        var transactionId: Int?
        var shipperCancelDriver: String?
        var scheduleTime: String?
        var deadhead: String?
        var trucks: EarningResTrucks?
        var shipperDetails: ShipperDetails?
...
struct EarningResTrucks: Codable {
    ...
    var truckId: Int?
    var payout: String?
    var truckType: EarningResTruckType?
    var truckTypeCategory: [EarningResTruckTypeCategory]?
    var note: String?
    var isHydraulic: Int?
    var isCooling: Int?
    var createdAt: String?
    ...
    init(from decoder: Decoder) throws {
        ...
        truckType = try values.decodeIfPresent(EarningResTruckType.self, forKey: .truckType)
...
struct EarningResTruckType: Codable {
