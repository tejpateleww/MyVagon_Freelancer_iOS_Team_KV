//
//  LoginVehicleCapacity.swift
//  Model Generated using http://www.jsoncafe.com/ 
//  Created on September 29, 2021

import Foundation

struct LoginVehicleCapacity : Codable {

        let createdAt : String?
        let driverVehicleId : Int?
        let id : Int?
        let packageTypeId : LoginPackageTypeId?
        ...
        init(from decoder: Decoder) throws {
                ...
                packageTypeId = try values?.decodeIfPresent(LoginPackageTypeId.self, forKey: .packageTypeId)
