...
//            self.drawFullCircleAnimated()
    ...
    private func drawCenterCircleAnimated() {
        ...
        self.centerCircleLayer.fillColor = UIColor(red: 155.0/255.0, green: 81.0/255.0, blue: 224.0/255.0, alpha: 1.0).cgColor// self.tintColor?.cgColor
    ...
    private func drawFullCircleAnimated() {
        ...
        self.fullCircleLayer.fillColor = UIColor.white.cgColor// self.tintColor?.cgColor
